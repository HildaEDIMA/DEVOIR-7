...
## Supprimons les variables créées lors de l'importation
table_de_conversion[8:25] <- NULL
View(table_de_conversion)

###Créons dans la base cereales et la base table_de_conversion une variable real_id qui est la concatÃ©nation des valeurs de produitID, UniteID et TailleID
View(cereales)
...
###procédons à la fusion de la base cereales et de la base table_de_conversion par la variable real_id
